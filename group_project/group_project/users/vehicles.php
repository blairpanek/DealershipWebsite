...
session_start();
  ...
  $query = "SELECT Vehicles.* FROM Vehicles WHERE Vehicle_ID NOT IN (SELECT UserVehicleWatchlist.Vehicle_ID FROM UserVehicleWatchlist) AND UserVehicleWatchlist.UserName = $username AND Vehicles.Dealership_ID = $dealership_id";
