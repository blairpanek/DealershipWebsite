...
session_start();
  ...
  $query = "SELECT Vehicles.* FROM Vehicles WHERE Vehicles.Vehicle_ID NOT IN (SELECT UserVehicleWatchlist.Vehicle_ID FROM UserVehicleWatchlist WHERE Vehicles.Vehicle_ID = UserVehicleWatchlist.Vehicle_ID)";
