...
session_start();
  ...
  $query = "SELECT Vehicles.* FROM (Vehicles WHERE Vehicles.Vehicle_ID NOT IN UserVehicleWatchlist AND Vehicles.Dealership_ID = $dealership_id AND UserVehicleWatchlist.UserName = $username)";
