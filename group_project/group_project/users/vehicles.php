...
session_start();
  ...
  $query = "SELECT Vehicles.*, UserVehicleWatchlist.Vehicle_ID FROM Vehicles INNER JOIN UserVehicleWatchlist ON NOT Vehicles.Vehicle_ID = UserVehicleWatchlist.Vehicle_ID";
