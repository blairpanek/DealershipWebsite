...
session_start();
  ...
  $query = "SELECT Vehicles.*, UserVehicleWatchlist.Vehicle_ID, UserVehicleWatchlist.UserName FROM ((Vehicles LEFT JOIN UserVehicleWatchlist ON UserVehicleWatchlist.UserName='$username') EXCEPT SELECT UserVehicleWatchlist.Vehicle_ID FROM UserVehicleWatchlist) WHERE Vehicles.Dealership_ID = $dealership_id";
