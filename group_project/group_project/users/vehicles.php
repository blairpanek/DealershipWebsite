...
session_start();
  ...
  $query = "SELECT Vehicles.*, UserVehicleWatchlist.Vehicle_ID, UserVehicleWatchlist.UserName FROM Vehicles INNER JOIN UserVehicleWatchlist ON UserVehicleWatchlist.UserName='$username' AND Vehicles.Vehicle_ID = UserVehicleWatchlist.Vehicle_ID AND Vehicles.Dealership_ID = $dealership_id";
