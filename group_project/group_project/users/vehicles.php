...
session_start();
  ...
  $query = "SELECT Vehicles.* FROM Vehicles WHERE NOT EXISTS (SELECT UserVehicleWatchlist.* FROM UserVehicleWatchlist) OR Vehicle_ID NOT IN (SELECT UserVehicleWatchlist.Vehicle_ID FROM UserVehicleWatchlist)";
