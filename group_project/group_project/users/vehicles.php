...
session_start();
  ...
  $query = "SELECT Vehicles.*, UserVehicleWatchlist.Vehicle_ID, UserVehicleWatchlist.UserName FROM (Vehicles Where Dealership_Id = $dealership_id) INNER JOIN UserVehicleWatchlist ON (NOT Vehicles.Vehicle_ID = UserVehicleWatchlist.Vehicle_ID AND UserVehicleWatchlist.UserName='$username'";
