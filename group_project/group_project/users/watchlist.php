...
$query = "SELECT Vehicles.*, UserVehicleWatchlist.Vehicle_ID FROM Vehicles INNER JOIN UserVehicleWatchlist ON Vehicles.Vehicle_ID = UserVehicleWatchlist.Vehicle_ID";
