...
$query = "SELECT * FROM Vehicles LEFT OUTER JOIN UserVehicleWatchlist ON ( 'Vehicles.Vehicle_id' = 'UserVehicleWatchlist.Vehicle_ID' AND 'UserVehicleWatchlist.UserName' = '$username' )";
$query = "";
